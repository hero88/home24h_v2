   ...
   if (gInfoUser == null) {
      ...
      try {
         ...
         $(document).ready(function () {
            ...
            //Khi click vào create Realestates
            ...
            $("#select-district").on("change", function () {
               ...
               if (vIdDistrict != 0) {
                  callApiWardByDistrictId(vIdDistrict);
               }
            });
            ...
            $("#select-ward").on("change", function () {
               ...
               let vWard = $(this).val();
               if (vWard != 0) {
                  callApiStreetByProvinceIdAndDistrictId(vIdProvince, vIdDistrict);
               }
            });
            ...
            function callApiCreateRealestates(paramData) {
               ...
               $.ajax({
                  type: "POST",
                  headers: gHeader,
                  url: `/realestates/post/${paramData.provinceId}/${paramData.districtId}/${paramData.wardId}/${paramData.streetId}/${paramData.projectId}`,
                  data: vData,
